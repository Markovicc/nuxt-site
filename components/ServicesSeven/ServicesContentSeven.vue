            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="single-services-box-item">
                        ...
                        <h3><NuxtLink to="/services-details-one">Big Data Analysis</NuxtLink></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod ut labore et dolore magna aliqua.</p>
                        <NuxtLink to="/services-details-one" class="learn-more-btn"><i class="flaticon-right"></i>Learn More</NuxtLink>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="single-services-box-item">
                        ...
                        <h3><NuxtLink to="/services-details-one">Robust  Analytics</NuxtLink></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod ut labore et dolore magna aliqua.</p>
                        <NuxtLink to="/services-details-one" class="learn-more-btn"><i class="flaticon-right"></i>Learn More</NuxtLink>
                        <div class="shape"><img src="../../assets/images/services/services-shape4.png" alt="image"></div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="single-services-box-item">
                        ...
                        <h3><NuxtLink to="/services-details-one">Marketing Analytics</NuxtLink></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod ut labore et dolore magna aliqua.</p>
                        <NuxtLink to="/services-details-one" class="learn-more-btn"><i class="flaticon-right"></i>Learn More</NuxtLink>
                        <div class="shape"><img src="../../assets/images/services/services-shape4.png" alt="image"></div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="single-services-box-item">
                        ...
                        <h3><NuxtLink to="/services-details-one">Data Visualization</NuxtLink></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod ut labore et dolore magna aliqua.</p>
                        <NuxtLink to="/services-details-one" class="learn-more-btn"><i class="flaticon-right"></i>Learn More</NuxtLink>
                        <div class="shape"><img src="../../assets/images/services/services-shape4.png" alt="image"></div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="single-services-box-item">
                        ...
                        <h3><NuxtLink to="/services-details-one">Securities Research</NuxtLink></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod ut labore et dolore magna aliqua.</p>
                        <NuxtLink to="/services-details-one" class="learn-more-btn"><i class="flaticon-right"></i>Learn More</NuxtLink>
                        <div class="shape"><img src="../../assets/images/services/services-shape4.png" alt="image"></div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="single-services-box-item">
                        ...
                        <h3><NuxtLink to="/services-details-one">Data Governance</NuxtLink></h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod ut labore et dolore magna aliqua.</p>
                        <NuxtLink to="/services-details-one" class="learn-more-btn"><i class="flaticon-right"></i>Learn More</NuxtLink>
                        <div class="shape"><img src="../../assets/images/services/services-shape4.png" alt="image"></div>
                    </div>
