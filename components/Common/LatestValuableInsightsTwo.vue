    ...
    <div class="blog-area pt-100 pb-70 bg-fffbf5">
        <div class="container">
            <div class="section-title">
                <span class="sub-title"><img src="~/assets/images/star-icon.png" alt="image"> Our Blog</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post">
                        ...
                        <div class="post-content">
                            ...
                            <h3><NuxtLink to="/blog-details-one">Six Ways to Make Smarter Decisions</NuxtLink></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post">
                        ...
                        <div class="post-content">
                            ...
                            <h3><NuxtLink to="/blog-details-one">The Challenges to Tackle Before You Start With AI</NuxtLink></h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                    <div class="single-blog-post">
                        ...
                        <div class="post-content">
                            ...
                            <h3><NuxtLink to="/blog-details-one">Why Organisations Want an Analytics Platform</NuxtLink></h3>
                        </div>
                    </div>
                </div>
            </div>
