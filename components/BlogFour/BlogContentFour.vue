                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="single-blog-post bg-fffbf5">
                                ...
                                <div class="post-content">
                                    ...
                                    <h3><NuxtLink to="/blog-details-one">The Data Surrounding Higher Education</NuxtLink></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="single-blog-post bg-fffbf5" >
                                ...
                                <div class="post-content">
                                    ...
                                    <h3><NuxtLink to="/blog-details-one">Conversion Rate the Sales Funnel Optimization</NuxtLink></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="single-blog-post bg-fffbf5" >
                                ...
                                <div class="post-content">
                                    ...
                                    <h3><NuxtLink to="/blog-details-one">Business Data is changing the world’s Energy</NuxtLink></h3>
                                </div>
                            </div>
                        </div>
