    ...
    <div>
        <div class="courses-details-area pb-100">
            <div class="courses-details-image">
                <img src="~/assets/images/courses/courses-details.jpg" alt="image">
            </div>
            ...
            <div class="container">
                <div class="row">
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-lg-4 col-md-4">
                                                    <div class="advisor-image">
                                                        <img src="~/assets/images/speaker/speaker2.jpg" alt="image">
                                                    </div>
                                                </div>
                  ...
                  style="cursor: pointer"
                            ...
                            <div class="btn-box">
                                <a href="#" class="default-btn"><i class="flaticon-shopping-basket"></i>Add to Cart<span></span></a>
                                <a href="#" class="default-btn"><i class="flaticon-price-tag"></i>Buy Now<span></span></a>
                            </div>
